    ...
    <div className="overflow-x-auto">
      <table className="min-w-full table-auto border-collapse border border-gray-200">
        <thead className="bg-gray-100">
          <tr>
            <th className="px-4 py-2 border text-sm md:text-base">ID</th>
            <th className="px-4 py-2 border text-sm md:text-base">Name</th>
            <th className="px-4 py-2 border text-sm md:text-base">Email</th>
            <th className="px-4 py-2 border text-sm md:text-base">College</th>
            <th className="px-4 py-2 border text-sm md:text-base">Branch</th>
            <th className="px-4 py-2 border text-sm md:text-base">
              Qualification
            </th>
            <th className="px-4 py-2 border text-sm md:text-base">
              Payment Type
            ...
            <th className="px-4 py-2 border text-sm md:text-base">Action</th>
          </tr>
        </thead>
        <tbody>
